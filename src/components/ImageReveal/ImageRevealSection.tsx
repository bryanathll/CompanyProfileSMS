...
import revealImageFile from "../../assets/kapal2sec.png";
...
const ImageRevealSection: React.FC = () => {
  ...
  return (
    <div ref={sectionRef} className={styles.section}>
      <img src={revealImageFile} alt="Kapal" className={styles.image} />

      <div className={styles.gradientOverlay}></div>

      <div className={styles.textContainer1}>
        <h2 className={styles.quote}>{t("teks1")}</h2>
      </div>

      <div className={styles.textContainer2}>
        <h2 className={styles.quote2}>{t("teks2")}</h2>
      </div>
    </div>
  );
};
