...
// Import gambar
import imgAgenPelabuhan from "../assets/CardJasa/AgenPelabuhansec.jpeg";
import imgAgenKapal from "../assets/CardJasa/jasasec.jpeg";
import imgPenangananKru from "../assets/CardJasa/PenangananKru.jpeg";
import imgPasokan from "../assets/CardJasa/PasokanPerbekalann.jpeg";
import imgPencairan from "../assets/CardJasa/PencairanAkuntasi.jpeg";
import imgLayananTambahan from "../assets/CardJasa/tanggapDarurat.jpeg";
...
const JasaSection: React.FC = () => {
  ...
  const jasaData = [
    {
      title: t("JasaTitleCard1"),
      image: imgAgenPelabuhan,
      description: t("jasaDesc1"),
    },
    {
      title: t("JasaTitleCard2"),
      image: imgAgenKapal,
      description: t("jasaDesc2"),
    },
    {
      title: t("JasaTitleCard3"),
      image: imgPenangananKru,
      description: t("jasaDesc3"),
    },
    {
      title: t("JasaTitleCard4"),
      image: imgPasokan,
      description: t("jasaDesc4"),
    },
    {
      title: t("JasaTitleCard5"),
      image: imgPencairan,
      description: t("jasaDesc5"),
    },
    {
      title: t("JasaTitleCard6"),
      image: imgLayananTambahan,
      description: t("jasaDesc6"),
    },
  ];
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      mainTimeline.to(
        ...
        "-=0.8",
      ); // Mulai sedikit sebelum animasi pertama benar-benar selesai
